...
class CustomSpeechCommandsDataset_Control(Dataset):
...
if __name__ == "__main__":
  ...
  dataset = CustomSpeechCommandsDataset_Control(base_dir=base_dir, n_segments=int(sys.argv[1]), subset="training", shuffle=True, vec_size=int(sys.argv[3]), divisor=32)
